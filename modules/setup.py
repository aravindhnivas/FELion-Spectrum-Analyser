...
executables = [cx_Freeze.Executable(
    "FELion_GUI_v3.py", base=base, icon="FELion_Icon.ico")]
remove_mods = ['matplotlib', 'scipy', 'numpy', 'PyQt5', 'notebook']
modules = ["FELion_sa", "FELion_power", "FELion_normline", "FELion_avgSpec",
           "FELion_massSpec", "FELion_definitions", "just_plot", "depletion_plot", "timescan_plot"]
