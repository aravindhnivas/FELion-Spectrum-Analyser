...
# Use the Canvas Element to create an animated graph. 
#  The code is a bit tricky to follow, but if you know Matplotlib then this recipe shouldn't be too difficult to copy and modify.      
